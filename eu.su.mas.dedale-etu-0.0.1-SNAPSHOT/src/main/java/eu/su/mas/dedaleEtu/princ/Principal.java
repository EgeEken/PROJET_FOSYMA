...
//		agentList.add(ag);	
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo1={"Explorer2", "GoldCollector", "GoldCollector2", "DiamondCollector", "DiamondCollector2"};
...
//
//		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersC1={"20", "0", "Explorer", "Explorer2", "GoldCollector2", "DiamondCollector", "DiamondCollector2"};
//
//		//4) Give the class name of your agent to let the system instantiate it
...
//
//		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersC2={"0", "20", "Explorer", "Explorer2", "GoldCollector", "GoldCollector2", "DiamondCollector2"};
//
//		//4) Give the class name of your agent to let the system instantiate it
...
//		//4) Give the class name of your agent to let the system instantiate it
		...
		//
		//4) Give the class name of your agent to let the system instantiate it
		//ag=createNewDedaleAgent(c, agentName, DummyTankerAgent.class.getName(), entityParametersExplo5);//ExploreSoloAgent
		//
		//agentList.add(ag);
