 ...
 * <ul>
 * <li> set the ConfigurationFile2_diffmap parameters (and maybe update the files in resources/) {@link ConfigurationFile2_diffmap}</li>
 * <li> create your agents classes and call them in the createAgents method below </li>
 * </ul>
 * @author hc
 *
 */
public class Principal2_diffmap {
	...
	public static void main(String[] args){
		...
		if(ConfigurationFile2_diffmap.COMPUTERisMAIN){
			...
			containerList.putAll(createAndConnectContainer(ConfigurationFile2_diffmap.LOCAL_CONTAINER_NAME, ConfigurationFile2_diffmap.PLATFORM_HOSTNAME, ConfigurationFile2_diffmap.PLATFORM_ID, ConfigurationFile2_diffmap.PLATFORM_PORT));
	...
	private static Runtime emptyPlatform(HashMap<String, ContainerController> containerList){
		...
		Profile pMain = new ProfileImpl(ConfigurationFile2_diffmap.PLATFORM_HOSTNAME,ConfigurationFile2_diffmap.PLATFORM_PORT,ConfigurationFile2_diffmap.PLATFORM_ID);
	...
	private static HashMap<String,ContainerController> createContainers(Runtime rt) {
		...
		containerName=ConfigurationFile2_diffmap.LOCAL_CONTAINER_NAME;
		pContainer = new ProfileImpl(ConfigurationFile2_diffmap.PLATFORM_HOSTNAME, ConfigurationFile2_diffmap.PLATFORM_PORT, ConfigurationFile2_diffmap.PLATFORM_ID);
		...
		//create the container0	
		containerName=ConfigurationFile2_diffmap.LOCAL_CONTAINER2_NAME;
		pContainer = new ProfileImpl(ConfigurationFile2_diffmap.PLATFORM_HOSTNAME, ConfigurationFile2_diffmap.PLATFORM_PORT, ConfigurationFile2_diffmap.PLATFORM_ID);
		pContainer.setParameter(Profile.CONTAINER_NAME,containerName);
		System.out.println("Launching container "+pContainer);
		containerRef = rt.createAgentContainer(pContainer); //ContainerController replace AgentContainer in the new versions of Jade.
		...
		containerName=ConfigurationFile2_diffmap.LOCAL_CONTAINER3_NAME;
		pContainer = new ProfileImpl(ConfigurationFile2_diffmap.PLATFORM_HOSTNAME, ConfigurationFile2_diffmap.PLATFORM_PORT, ConfigurationFile2_diffmap.PLATFORM_ID);
		...
		containerName=ConfigurationFile2_diffmap.LOCAL_CONTAINER4_NAME;
		pContainer = new ProfileImpl(ConfigurationFile2_diffmap.PLATFORM_HOSTNAME, ConfigurationFile2_diffmap.PLATFORM_PORT, ConfigurationFile2_diffmap.PLATFORM_ID);
		//pContainer = new ProfileImpl(null, 8888, null);
		pContainer.setParameter(Profile.CONTAINER_NAME,containerName);
		System.out.println("Launching container "+pContainer);
	...
	private static HashMap<String,ContainerController> createAndConnectContainer(String containerName,String host, String platformID, Integer port){
		...
		if (port==null){
			port=ConfigurationFile2_diffmap.PLATFORM_PORT;
		}
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		if (ConfigurationFile2_diffmap.COMPUTERisMAIN){
			 ...
			 */
			c = containerList.get(ConfigurationFile2_diffmap.LOCAL_CONTAINER_NAME);
			Assert.assertNotNull("This container does not exist",c);
			agentName=ConfigurationFile2_diffmap.DEFAULT_GATEKEEPER_NAME;
			try {
				Object[] objtab=new Object[]{ConfigurationFile2_diffmap.ENVIRONMENT_TYPE,ConfigurationFile2_diffmap.GENERATOR_TYPE,ConfigurationFile2_diffmap.INSTANCE_TOPOLOGY,ConfigurationFile2_diffmap.INSTANCE_CONFIGURATION_ELEMENTS,ConfigurationFile2_diffmap.ACTIVE_DIAMOND,ConfigurationFile2_diffmap.ACTIVE_GOLD,ConfigurationFile2_diffmap.ACTIVE_WELL,ConfigurationFile2_diffmap.GENERATOR_PARAMETERS};//used to give informations to the agent
				//Object[] objtab=new Object[]{null,null,ConfigurationFile2_diffmap.ENVIRONMENT_TYPE};//used to give informations to the agent
		...
		//				c = containerList.get(ConfigurationFile2_diffmap.LOCAL_CONTAINER2_NAME);
		//				Assert.assertNotNull("This container does not exist",c);
		//		
...
//		agentList.add(ag);	
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo1={"GoldCollector", "DiamondCollector"};
...
//
//		//3) If you want to give specific parameters to your agent, add them here
		//Object [] entityParametersExplo2={"Explorer", "GoldCollector", "GoldCollector2", "DiamondCollector", "DiamondCollector2"};
//
//		//4) Give the class name of your agent to let the system instantiate it
		//ag=createNewDedaleAgent(c, agentName, ExplorerAgent.class.getName(), entityParametersExplo2);//ExploreSoloAgent
		//agentList.add(ag);
...
//
//		//2) Give the name of your agent, MUST be the same as the one given in the entities file.
		agentName="GoldCollector";
//
//		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersC1={"20", "0", "Explorer", "DiamondCollector"};
//
//		//4) Give the class name of your agent to let the system instantiate it
...
//
//		//2) Give the name of your agent, MUST be the same as the one given in the entities file.
		agentName="DiamondCollector";
//
//		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersC2={"0", "20", "Explorer", "GoldCollector"};
//
//		//4) Give the class name of your agent to let the system instantiate it
...
//
//		//2) Give the name of your agent, MUST be the same as the one given in the entities file.
		//agentName="GoldCollector2";
//
//		//3) If you want to give specific parameters to your agent, add them here
		//Object [] entityParametersC3={"20", "0", "Explorer", "Explorer2", "GoldCollector", "DiamondCollector", "DiamondCollector2"};
//
//		//4) Give the class name of your agent to let the system instantiate it
...
//
//		//2) Give the name of your agent, MUST be the same as the one given in the entities file.
		//agentName="DiamondCollector2";
//
//		//3) If you want to give specific parameters to your agent, add them here
		//Object [] entityParametersC4={"0", "20", "Explorer", "Explorer2", "GoldCollector", "GoldCollector2", "DiamondCollector"};
//
//		//4) Give the class name of your agent to let the system instantiate it
...
//		//4) Give the class name of your agent to let the system instantiate it
	...
	private static AgentController createNewDedaleAgent(ContainerController initialContainer, String agentName,String className, Object[] additionnalParameters){
		...
		Object[] objtab=AbstractDedaleAgent.loadEntityCaracteristics(agentName,ConfigurationFile2_diffmap.INSTANCE_CONFIGURATION_ENTITIES);
