 ...
 * <ul>
 * <li> set the ConfigurationFile2 parameters (and maybe update the files in resources/) {@link ConfigurationFile22}</li>
...
public class Principal2 {
	...
	public static void main(String[] args){
		...
		if(ConfigurationFile2.COMPUTERisMAIN){
			...
			containerList.putAll(createAndConnectContainer(ConfigurationFile2.LOCAL_CONTAINER_NAME, ConfigurationFile2.PLATFORM_HOSTNAME, ConfigurationFile2.PLATFORM_ID, ConfigurationFile2.PLATFORM_PORT));
	...
	private static Runtime emptyPlatform(HashMap<String, ContainerController> containerList){
		...
		Profile pMain = new ProfileImpl(ConfigurationFile2.PLATFORM_HOSTNAME,ConfigurationFile2.PLATFORM_PORT,ConfigurationFile2.PLATFORM_ID);
	...
	private static HashMap<String,ContainerController> createContainers(Runtime rt) {
		...
		containerName=ConfigurationFile2.LOCAL_CONTAINER_NAME;
		pContainer = new ProfileImpl(ConfigurationFile2.PLATFORM_HOSTNAME, ConfigurationFile2.PLATFORM_PORT, ConfigurationFile2.PLATFORM_ID);
		...
		//create the container0	
		containerName=ConfigurationFile2.LOCAL_CONTAINER2_NAME;
		pContainer = new ProfileImpl(ConfigurationFile2.PLATFORM_HOSTNAME, ConfigurationFile2.PLATFORM_PORT, ConfigurationFile2.PLATFORM_ID);
		pContainer.setParameter(Profile.CONTAINER_NAME,containerName);
		System.out.println("Launching container "+pContainer);
		containerRef = rt.createAgentContainer(pContainer); //ContainerController replace AgentContainer in the new versions of Jade.
		...
		containerName=ConfigurationFile2.LOCAL_CONTAINER3_NAME;
		pContainer = new ProfileImpl(ConfigurationFile2.PLATFORM_HOSTNAME, ConfigurationFile2.PLATFORM_PORT, ConfigurationFile2.PLATFORM_ID);
		...
		containerName=ConfigurationFile2.LOCAL_CONTAINER4_NAME;
		pContainer = new ProfileImpl(ConfigurationFile2.PLATFORM_HOSTNAME, ConfigurationFile2.PLATFORM_PORT, ConfigurationFile2.PLATFORM_ID);
		//pContainer = new ProfileImpl(null, 8888, null);
		pContainer.setParameter(Profile.CONTAINER_NAME,containerName);
		System.out.println("Launching container "+pContainer);
	...
	private static HashMap<String,ContainerController> createAndConnectContainer(String containerName,String host, String platformID, Integer port){
		...
		if (port==null){
			port=ConfigurationFile2.PLATFORM_PORT;
		}
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		if (ConfigurationFile2.COMPUTERisMAIN){
			 ...
			 */
			c = containerList.get(ConfigurationFile2.LOCAL_CONTAINER_NAME);
			Assert.assertNotNull("This container does not exist",c);
			agentName=ConfigurationFile2.DEFAULT_GATEKEEPER_NAME;
			try {
				Object[] objtab=new Object[]{ConfigurationFile2.ENVIRONMENT_TYPE,ConfigurationFile2.GENERATOR_TYPE,ConfigurationFile2.INSTANCE_TOPOLOGY,ConfigurationFile2.INSTANCE_CONFIGURATION_ELEMENTS,ConfigurationFile2.ACTIVE_DIAMOND,ConfigurationFile2.ACTIVE_GOLD,ConfigurationFile2.ACTIVE_WELL,ConfigurationFile2.GENERATOR_PARAMETERS};//used to give informations to the agent
				//Object[] objtab=new Object[]{null,null,ConfigurationFile2.ENVIRONMENT_TYPE};//used to give informations to the agent
		...
		//				c = containerList.get(ConfigurationFile2.LOCAL_CONTAINER2_NAME);
		//				Assert.assertNotNull("This container does not exist",c);
		//		
...
//		//4) Give the class name of your agent to let the system instantiate it
	...
	private static AgentController createNewDedaleAgent(ContainerController initialContainer, String agentName,String className, Object[] additionnalParameters){
		...
		Object[] objtab=AbstractDedaleAgent.loadEntityCaracteristics(agentName,ConfigurationFile2.INSTANCE_CONFIGURATION_ENTITIES);
