 ...
 * <ul>
 * <li> set the ConfigurationFileFINAL parameters (and maybe update the files in resources/) {@link ConfigurationFileFINAL}</li>
...
public class PrincipalFINAL {
	...
	public static void main(String[] args){
		...
		if(ConfigurationFileFINAL.COMPUTERisMAIN){
			...
			containerList.putAll(createAndConnectContainer(ConfigurationFileFINAL.LOCAL_CONTAINER_NAME, ConfigurationFileFINAL.PLATFORM_HOSTNAME, ConfigurationFileFINAL.PLATFORM_ID, ConfigurationFileFINAL.PLATFORM_PORT));
	...
	private static Runtime emptyPlatform(HashMap<String, ContainerController> containerList){
		...
		Profile pMain = new ProfileImpl(ConfigurationFileFINAL.PLATFORM_HOSTNAME,ConfigurationFileFINAL.PLATFORM_PORT,ConfigurationFileFINAL.PLATFORM_ID);
	...
	private static HashMap<String,ContainerController> createContainers(Runtime rt) {
		...
		containerName=ConfigurationFileFINAL.LOCAL_CONTAINER_NAME;
		pContainer = new ProfileImpl(ConfigurationFileFINAL.PLATFORM_HOSTNAME, ConfigurationFileFINAL.PLATFORM_PORT, ConfigurationFileFINAL.PLATFORM_ID);
		...
		//create the container0	
		containerName=ConfigurationFileFINAL.LOCAL_CONTAINER2_NAME;
		pContainer = new ProfileImpl(ConfigurationFileFINAL.PLATFORM_HOSTNAME, ConfigurationFileFINAL.PLATFORM_PORT, ConfigurationFileFINAL.PLATFORM_ID);
		pContainer.setParameter(Profile.CONTAINER_NAME,containerName);
		System.out.println("Launching container "+pContainer);
		containerRef = rt.createAgentContainer(pContainer); //ContainerController replace AgentContainer in the new versions of Jade.
		...
		containerName=ConfigurationFileFINAL.LOCAL_CONTAINER3_NAME;
		pContainer = new ProfileImpl(ConfigurationFileFINAL.PLATFORM_HOSTNAME, ConfigurationFileFINAL.PLATFORM_PORT, ConfigurationFileFINAL.PLATFORM_ID);
		...
		containerName=ConfigurationFileFINAL.LOCAL_CONTAINER4_NAME;
		pContainer = new ProfileImpl(ConfigurationFileFINAL.PLATFORM_HOSTNAME, ConfigurationFileFINAL.PLATFORM_PORT, ConfigurationFileFINAL.PLATFORM_ID);
		//pContainer = new ProfileImpl(null, 8888, null);
		pContainer.setParameter(Profile.CONTAINER_NAME,containerName);
		System.out.println("Launching container "+pContainer);
	...
	private static HashMap<String,ContainerController> createAndConnectContainer(String containerName,String host, String platformID, Integer port){
		...
		if (port==null){
			port=ConfigurationFileFINAL.PLATFORM_PORT;
		}
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		if (ConfigurationFileFINAL.COMPUTERisMAIN){
			 ...
			 */
			c = containerList.get(ConfigurationFileFINAL.LOCAL_CONTAINER_NAME);
			Assert.assertNotNull("This container does not exist",c);
			agentName=ConfigurationFileFINAL.DEFAULT_GATEKEEPER_NAME;
			try {
				Object[] objtab=new Object[]{ConfigurationFileFINAL.ENVIRONMENT_TYPE,ConfigurationFileFINAL.GENERATOR_TYPE,ConfigurationFileFINAL.INSTANCE_TOPOLOGY,ConfigurationFileFINAL.INSTANCE_CONFIGURATION_ELEMENTS,ConfigurationFileFINAL.ACTIVE_DIAMOND,ConfigurationFileFINAL.ACTIVE_GOLD,ConfigurationFileFINAL.ACTIVE_WELL,ConfigurationFileFINAL.GENERATOR_PARAMETERS};//used to give informations to the agent
				//Object[] objtab=new Object[]{null,null,ConfigurationFileFINAL.ENVIRONMENT_TYPE};//used to give informations to the agent
		...
		//				c = containerList.get(ConfigurationFileFINAL.LOCAL_CONTAINER2_NAME);
		//				Assert.assertNotNull("This container does not exist",c);
		//		
...
//		//4) Give the class name of your agent to let the system instantiate it
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo1={"C1", "C2", "C3", "C4"};
		...
		Assert.assertNotNull("This container does not exist",c);
		agentName="C1";
		Object [] entityParametersC1={"10", "0", "E1", "C2", "C3", "C4"};
		...
		Assert.assertNotNull("This container does not exist",c);
		agentName="C2";
		Object [] entityParametersC2={"0", "25", "E1", "C1", "C3", "C4"};
		...
		Assert.assertNotNull("This container does not exist",c);
		agentName="C3";
		Object [] entityParametersC3={"45", "0", "E1", "C1", "C2", "C4"};
		...
		Assert.assertNotNull("This container does not exist",c);
		agentName="C4";
		Object [] entityParametersC4={"0", "15", "E1", "C1", "C2", "C3"};
...
//		//4) Give the class name of your agent to let the system instantiate it
	...
	private static AgentController createNewDedaleAgent(ContainerController initialContainer, String agentName,String className, Object[] additionnalParameters){
		...
		Object[] objtab=AbstractDedaleAgent.loadEntityCaracteristics(agentName,ConfigurationFileFINAL.INSTANCE_CONFIGURATION_ENTITIES);
