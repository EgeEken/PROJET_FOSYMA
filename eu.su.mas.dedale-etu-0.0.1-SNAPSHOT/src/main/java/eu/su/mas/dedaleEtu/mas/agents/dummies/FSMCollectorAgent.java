...
import eu.su.mas.dedaleEtu.mas.behaviours.fsm_states.FSMCollectorBehaviour;
 ...
 */
public class FSMCollectorAgent extends AbstractDedaleAgent {
    ...
    protected void setup() {
		...
		if(args.length==0){
			...
			this.GOLD_CAPACITY = Integer.parseInt((String)args[2]);
            this.DIAMOND_CAPACITY = Integer.parseInt((String)args[3]);
            i = 4;
			while (i<args.length) {
        ...
        lb.add(new FSMCollectorBehaviour(this, 600));
